...
namespace DataStructures.Lists
{
	...
	public class DLinkedList<TKey, TValue> : IEnumerable<TKey, TValue> where TKey : IComparable<TKey>
	{
		...
		/// </summary>
		protected virtual void _setNodeByIndex(int index, TValue value)
		{
		...
		/// </summary>
		public virtual DLinkedListNode<TKey, TValue> First
		{
			get
			{
				if (IsEmpty())
		...
		/// </summary>
		public virtual DLinkedListNode<TKey, TValue> Last
		{
			get
			{
				if (IsEmpty())
		...
		/// <summary>
		/// Gets or sets the element's value at the specified index
		/// </summary>
		public virtual TValue this[int index]
		{
			get { return this._getNodeByIndex(index).Value; }
			set { this._setNodeByIndex(index, value); }
		}
		...
		/// </summary>
		public virtual DLinkedListNode<TKey, TValue> Find(TKey key)
		{
			if (IsEmpty())
				throw new Exception("List is empty.");
		...
		public virtual List<TKey> FindAll(Predicate<TKey> match)
		{
			if (IsEmpty())
				throw new Exception("List is empty.");
		...
		public virtual DLinkedList<TKey> GetRange(int index, int countOfElements)
		{
			DLinkedListNode<TKey, TValue> currentNode = null;
			DLinkedList<TKey> newList = new DLinkedList<TKey>();
			...
			{
				newList.Append(currentNode.Key);
				currentNode = currentNode.Next;
			}
