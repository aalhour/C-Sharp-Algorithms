...
namespace AlgorithmsTests.Sorting
{
    ...
    public class BubbleSorterTests
    {
        ...
        public void BubbleSortTest(int[] toSortInts, int[] expectedSortedInts)
        {
            toSortInts.BubbleSort();
        ...
        [TestCase(new[] { 1, 9, 3, 7, 5, 2 }, new[] { 1, 2, 3, 5, 7, 9 })]
        [TestCase(new[] { 541, 87, 23, 87, 18, 687, 1587, 579, 25742, 5841, 2 }, new[] { 2, 18, 23, 87, 87, 541, 579, 687, 1587, 5841, 25742 })]
        public void BubbleSortAscendingTest(int[] toSortInts, int[] expectedSortedInts)
        {
            toSortInts.BubbleSortAscending(Comparer<int>.Default);
            CollectionAssert.AreEqual(toSortInts, expectedSortedInts);
        }
        ...
        public void BubbleSortDescendingTest(int[] toSortInts, int[] expectedSortedInts)
        {
            toSortInts.BubbleSortDescending(Comparer<int>.Default);
            CollectionAssert.AreEqual(toSortInts, expectedSortedInts);
        }
    }
}
